...
class DLModelBase(object):
    ...
    def model_error_multiple_traj(self, coeffs, trajectories, groupby_cols):
        ...
        return trajectories.groupby(by=groupby_cols).apply(single_traj_error).mean()
        
    def model_error_jac_multiple_traj(self, coeffs, trajectories, groupby_cols):
        ...
        return trajectories.groupby(by=groupby_cols).apply(single_traj_error_jac).mean()
